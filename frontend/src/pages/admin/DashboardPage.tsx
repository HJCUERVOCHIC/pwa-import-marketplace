          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Has iniciado sesión correctamente en el panel administrativo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-gray-900">Gestión de Listas</p>
            ...
            <div className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
              ...
              <div className="flex-1 min-w-0">
                <span className="absolute inset-0" aria-hidden="true" />
                <p className="text-sm font-medium text-gray-900">Gestión de Productos</p>
                <p className="text-sm text-gray-500 truncate">
                  Próximamente disponible
                </p>
              </div>
